class HazelcastEnterpriseAT524Snapshot < Formula
    desc "Hazelcast is a streaming and memory-first application platform for fast, stateful, data-intensive workloads on-premises, at the edge or as a fully managed cloud service."
    homepage "https://github.com/hazelcast/hazelcast-command-line"
    url "https://repository.hazelcast.com/snapshot/com/hazelcast/hazelcast-enterprise-distribution/5.2.4-SNAPSHOT/hazelcast-enterprise-distribution-5.2.4-20230522.085528-33.tar.gz"
    sha256 "a39eddb534447c993ba3cebfd9756b99e4e76b8e90c00b6588f577a9cb2ebb33"
