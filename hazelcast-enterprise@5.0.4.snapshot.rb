class HazelcastEnterpriseAT504Snapshot < Formula
    desc "Hazelcast is a streaming and memory-first application platform for fast, stateful, data-intensive workloads on-premises, at the edge or as a fully managed cloud service."
    homepage "https://github.com/hazelcast/hazelcast-command-line"
    url "https://repository.hazelcast.com/snapshot/com/hazelcast/hazelcast-enterprise-distribution/5.0.4-SNAPSHOT/hazelcast-enterprise-distribution-5.0.4-20220802.095504-40.tar.gz"
    sha256 "0ab44f1582254031b71477152f9e81acdf4e7882b520b1982812411917f3da8f"
