class HazelcastEnterpriseAT531Snapshot < Formula
    desc "Hazelcast is a streaming and memory-first application platform for fast, stateful, data-intensive workloads on-premises, at the edge or as a fully managed cloud service."
    homepage "https://github.com/hazelcast/hazelcast-command-line"
    url "https://repository.hazelcast.com/snapshot/com/hazelcast/hazelcast-enterprise-distribution/5.3.1-SNAPSHOT/hazelcast-enterprise-distribution-5.3.1-20230522.074953-8.tar.gz"
    sha256 "b626ad149d2bb1f4eaaee4381ad032d511e0d2e8d442c70b030595abd9b687af"
