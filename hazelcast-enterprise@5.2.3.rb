class HazelcastEnterpriseAT523 < Formula
    desc "Hazelcast is a streaming and memory-first application platform for fast, stateful, data-intensive workloads on-premises, at the edge or as a fully managed cloud service."
    homepage "https://github.com/hazelcast/hazelcast-command-line"
    url "https://repository.hazelcast.com/release/com/hazelcast/hazelcast-enterprise-distribution/5.2.3/hazelcast-enterprise-distribution-5.2.3.tar.gz"
    sha256 "be42733c91d5cfdf65875f40972b6dbc071c0bd4b9bf5f9a795140917062fa76"
