class HazelcastSnapshot < Formula
    ...
    url "/com/hazelcast/hazelcast-distribution/5.8.0-SNAPSHOT/hazelcast-distribution-5.8.0-SNAPSHOT.tar.gz"
    sha256 "d70f48cad002ceac97c0734d7aa71d65b3f244fe5d54d51bb34620efea16c1ac"
    ...
    conflicts_with "hazelcast-enterprise@5.6.1.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast-enterprise@5.5.8.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast-enterprise@5.5.6.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast-enterprise@5.4.4.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast-enterprise@5.4.2.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast-enterprise@5.3.9.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast-enterprise@5.3.6.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast-enterprise@5.3.1.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast-enterprise@5.2.6.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast-enterprise@5.2.5.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast-enterprise@5.2.4.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast-enterprise@5.1.7.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast@5.8.0.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
